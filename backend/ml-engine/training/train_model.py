...
logs, anomalous_ips = generate_training_logs(num_anomalous_ips=10, num_normal_ips=300)
features = compute_features(logs)

contamination = len(anomalous_ips) / len(features)
...
actual_anomalous_ips = set(anomalous_ips)
